...
define('DB_PASS', ''); //Enter your database ppassword here
define('DB_NAME', 'individu'); //Enter the name of the database you created here, make sure you have import the provided sql
 //error_reporting(0);
if(empty(DB_NAME)){
